...
from sim_game.msg import Sim, obstacle_roomba, SimMap
import numpy as np
import rospy
...
class Roomba(robot):
    def __init__(self):
       ...
       #self.ros.create_publisher('Target_Roomba', SimMap)
    ...
    def populate_publish_roomba_msg(self):
        ...
        self.ros_msg_type.prob_rad = self._radius
...
class Obstacle_Roomba(robot):
    def __init__(self, pos, heading, _id):
      ...
      self.ros_msg_type = obstacle_roomba()

      #self.ros = ROSExtension()

      #self.ros.create_publisher('Obstacle_Roomba', obstacle_roomba)
    ...
    def populate_publish_roomba_msg(self):
      ...
      self.ros_msg_type.heading = self.heading
