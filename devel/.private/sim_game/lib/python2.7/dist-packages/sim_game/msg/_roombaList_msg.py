...
"""autogenerated by genpy from sim_game/roombaList_msg.msg. Do not edit."""
import sys
...
float64 r 			# Roomba probability radius"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(roombaList_msg, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.roombaList)
      buff.write(_struct_I.pack(length))
      for val1 in self.roombaList:
        _v1 = val1.header
