...
class roomba_msg(genpy.Message):
  _md5sum = "85d49906735be78e3facee055f16d425"
...
string frame_id
"""
  __slots__ = ['header','id','x','y','detected','r']
  _slot_types = ['std_msgs/Header','int64','float64','float64','bool','float64']
